        ...
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            <Card className="border-primary/20 shadow-lg">
                ...
                <CardContent className="space-y-4 text-foreground/90 leading-relaxed">
                    <p>
                        <strong>Avaliador Didático da Computação</strong> é um
                        sistema desenvolvido como parte de um Trabalho de
                        Conclusão de Curso, com foco em apoiar docentes por meio
                        de uma autoavaliação baseada no Hexágono Didático da
                        Computação.
                    </p>
                    ...
                    <div className="space-y-1">
                        ...
                        <p>
                            ...
                            Computação (Castro, 2019)
                        </p>
                    </div>

                    <p className="text-sm text-muted-foreground">
                        Este sistema foi projetado para oferecer uma experiência
                        simples, intuitiva e alinhada a estudos recentes sobre
                        práticas pedagógicas em Computação.
                    </p>
                </CardContent>
            </Card>
            ...
            <Card className="border-primary/20 shadow-lg">
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4 pt-4">
                        <p className="text-foreground/90 leading-relaxed">
                            Na tese, discute-se como aulas expositivas e
            ...
            <Card className="border-primary/20 shadow-lg">
                ...
                <CardContent className="space-y-4">
                    ...
                    <p className="text-foreground/90 leading-relaxed">
                        ...
                        passivamente. Esse modelo nunca funcionou para mim. Em
                    ...
                    <div className="bg-primary/5 border-l-4 border-primary p-4 rounded-r-lg mt-6">
                        <p className="text-foreground/90 font-medium">
                            Este projeto, então, não é só um requisito
                            acadêmico, é um espaço para explorar novas formas de
                            ensinar Computação, fugindo da lógica do "professor
                            fala, aluno escuta" e caminhando para um ambiente
                            onde o estudante realmente vive o conhecimento.
                        </p>
                    </div>
                </CardContent>
            </Card>
